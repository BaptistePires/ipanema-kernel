...
/* SaaKM */
DECLARE_STATIC_KEY_FALSE(__saakm_loaded);

#define saakm_enabled() static_branch_unlikely(&__saakm_loaded)
...
extern void sched_balance_trigger_ipanema(struct rq *rq);
